...
export const BuyButton: React.FC<BuyButtonProps> = ({
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className={`fixed top-0 right-0 h-screen w-full max-w-lg bg-white rounded-2xl shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'
        }`}>
        {/* Header */}
