     ...
     <span className="hidden md:block">   Buy Now</span>
      ...
      <div className={`fixed top-0 right-0 h-screen w-full max-w-lg bg-[#F8F9FA] rounded-bl-[40px] rounded-r-none z-50 transform transition-transform duration-300 ease-in-out md:top-4 md:h-[calc(100vh-2rem)] md:rounded-2xl border border-gray-200/50 backdrop-blur-sm ${isOpen ? 'translate-x-0 md:right-4' : 'translate-x-full md:right-0'
        ...
        <div className="flex flex-col" style={{ height: 'calc(100vh - 9px - 80px)' }}>
              ...
              {currentStep === 0 && (
                <div className="space-y-1">
                  ...
                  <div className="pt-3">
                    ...
                    {getTotalPairs() > 0 && (
                      <div className="bg-gray-50 py-2 px-4 mt-6 rounded-lg border border-gray-200">
          ...
          {/* Footer */}
          <div className="border border-slate-400/20 mx-3 my-5 mb-8 bg-gradient-to-r from-slate-400/10 to-slate-400/0 rounded-2xl p-4">
