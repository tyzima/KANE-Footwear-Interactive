      ...
      <main className="h-screen relative">
        ...
        <div className="absolute top-8 left-8 z-30 flex items-center gap-4">
          <img
            ...
            alt="KANE Logo"
            className={`h-12 w-auto transition-all duration-300 ${isDarkBackground ? 'invert' : ''}`}
          />
          <div>
            <div className="flex items-center gap-3">
              <h1 className={`text-2xl font-bold transition-colors duration-300 ${isDarkBackground ? 'text-white' : 'text-foreground'}`}></h1>
              <span className={`px-2 py-1 text-xs font-medium rounded-full transition-colors duration-300 ${isDarkBackground
